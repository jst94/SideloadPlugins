...
public interface InfernoConfig extends Config
{
    ...
    @ConfigItem(
        position = 5,
        keyName = "getCriticalBoxColor",
        name = "Critical Box Color",
        description = "Color for the descending box when prayer change is critical (1 tick)",
        section = PrayerSection
    )
    default Color getCriticalBoxColor()
    {
        return Color.RED;
    }
    ...
    @ConfigItem(
        position = 6,
        keyName = "getNormalBoxColor", 
        name = "Normal Box Color",
        description = "Color for non-critical descending boxes",
        section = PrayerSection
    )
    default Color getNormalBoxColor()
    {
        return Color.ORANGE;
    }
